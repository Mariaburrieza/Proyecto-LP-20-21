...
class BicicletaCarretera: public Bicicleta {
	public:
		...
		BicicletaCarretera(const BicicletaCarretera& bc): Bicicleta(bc) { m_modalitat = bc.m_modalitat; m_electrica = b.m_electrica; }
		...
		void setElectricaC(const bool& electrica) { if(electrica) m_electrica = true; else m_electrica = false; } 
