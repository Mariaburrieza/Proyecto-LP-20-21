...
public:
	...
	Bicicleta() {}
	Bicicleta(const string& model, const string& descripcio, int temporada, const Talla& talla, const Quadre& quadre, const Roda& roda, const Fre& fre, const Tipus& tipus):
